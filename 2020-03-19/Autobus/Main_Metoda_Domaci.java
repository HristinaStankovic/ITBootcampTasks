...
public class Main_Metoda_Domaci {
	...
	public static void main(String[] args) {
		...
		Putnik ptnk1 = new Putnik("Lana", "Del Rej", 1000);
		Putnik ptnk2 = new Putnik("Mali", "Mikica", 200);
		Putnik ptnk3 = new Putnik("Iva","Lozic", 0);
		Vozac vzc1 = new Vozac("Milena", "Tomic");
		Autobus bus = new Autobus("Pariz - Ljoret Del Mar", 100, 10);
